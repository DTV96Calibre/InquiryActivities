function TestSurfaceTension() {
  ...
  shape.vertices[2] = new b2Vec2(-2, 4);
  shape.vertices[3] = new b2Vec2(-4, 4);
  ground.CreateFixtureFromShape(shape, 0.0);
  ...
  shape.vertices[2] = new b2Vec2(4, 4);
  shape.vertices[3] = new b2Vec2(2, 4);
  ground.CreateFixtureFromShape(shape, 0.0);
  ...
  // fluid A (already in beaker)
  var box = new b2PolygonShape();
  var pgd = new b2ParticleGroupDef();
  box.vertices[0] = new b2Vec2(-1.9, 1.5);
  box.vertices[1] = new b2Vec2(1.9, 1.5);
  box.vertices[2] = new b2Vec2(1.9, 0.1);
  box.vertices[3] = new b2Vec2(-1.9, 0.1);
  pgd.flags = b2_tensileParticle | b2_colorMixingParticle;
  pgd.shape = box;
  pgd.color.Set(0, 0, 255, 255);
  particleSystem.CreateParticleGroup(pgd);

  // fluid B (dropping into beaker)
  var box = new b2PolygonShape();
  var pgd = new b2ParticleGroupDef();
  box.vertices[0] = new b2Vec2(-1.9, 3.4);
  box.vertices[1] = new b2Vec2(1.9, 3.4);
  box.vertices[2] = new b2Vec2(1.9, 2);
  box.vertices[3] = new b2Vec2(-1.9, 2);
  pgd.flags = b2_tensileParticle | b2_colorMixingParticle;
  pgd.shape = box;
